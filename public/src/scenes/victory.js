...
export class VictoryScreen extends Phaser.Scene {
    ...
    create() {
            ...
            // Punto de partida dinámico basado en la altura de la descripción
            ...
            // 6. Botón Continuar (Te lleva a los créditos)
            this.add.text(width / 2, height * 0.85, Texts.continue, {
              fontSize: `${md}px`,
              ...TextStyles.success
            }).setOrigin(0.5);
            ...
            this.input.once('pointerdown', () => {
              this.sound.stopAll();
              this.scene.start('credits'); // Direcciona a créditos
            });
        }
